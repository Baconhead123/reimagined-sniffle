local function loadScript()
    ...
    BlurBackground.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
    BlurBackground.BackgroundTransparency = 0.2
    BlurBackground.ZIndex = 0
    Instance.new("UICorner", BlurBackground).CornerRadius = UDim.new(0, 12)
    ...
    TitleLabel.TextColor3 = Color3.fromRGB(0, 255, 255) -- 蓝色主题色
    ...
    TabFrame.Size = UDim2.new(0, 180, 1, -45)
    ...
    MainContent.Size = UDim2.new(1, -180, 1, -45)
    MainContent.Position = UDim2.new(0, 180, 0, 45)
    ...
    local function createButton(text, description)
        ...
        buttonFrame.Size = UDim2.new(1, -10, 0, 50) -- 宽度填满减去边距，高度固定
        buttonFrame.BackgroundTransparency = 1
        buttonFrame.LayoutOrder = #ContentScrolling:GetChildren()
        
        local button = Instance.new("TextButton")
        button.Size = UDim2.new(1, 0, 1, 0) -- 填充整个按钮框架
        ...
        if description then
            button.MouseEnter:Connect(function()
                ...
                tooltip.Position = UDim2.new(0, -90, 1, 5)
                ...
                TweenService:Create(tooltip, TweenInfo.new(0.2), {Size = UDim2.new(0, 180, 0, 60)}):Play()
            end)
            
            button.MouseLeave:Connect(function()
                local tooltip = buttonFrame:FindFirstChildWhichIsA("TextLabel")
                if tooltip then
                    TweenService:Create(tooltip, TweenInfo.new(0.2), {Size = UDim2.new(0, 180, 0, 0)}):Play()
                    wait(0.2)
                    tooltip:Destroy()
                end
            end)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for tName, tButton in pairs(TabButtons) do
                if tName == tabName then
                    tButton.BackgroundColor3 = Color3.fromRGB(0, 150, 255) -- 蓝色主题色
    ...
    local function toggleMinimize()
        ...
        if minimized then
            ...
            TweenService:Create(MainFrame, TweenInfo.new(0.3), {Size = UDim2.new(0, 850, 0, 500)}):Play()
            MinimizeButton.Text = "_"
        end
    end
...
print("安全版自然灾害免疫已激活")
    ...
    startupFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
    startupFrame.BackgroundTransparency = 0.3
    startupFrame.ZIndex = 100
    startupFrame.Parent = ScreenGui
    
    -- 毛玻璃背景图片
    local startupBlur = Instance.new("ImageLabel")
    startupBlur.Size = UDim2.new(1, 0, 1, 0)
    startupBlur.BackgroundTransparency = 1
    startupBlur.Image = "rbxassetid://89036103941643"
    startupBlur.ImageTransparency = 0.7
    startupBlur.ScaleType = Enum.ScaleType.Crop
    startupBlur.ZIndex = 101
    startupBlur.Parent = startupFrame
    ...
    startupLabel.TextColor3 = Color3.fromRGB(0, 255, 255) -- 蓝色主题色
    startupLabel.TextSize = 28
    startupLabel.Font = Enum.Font.GothamBold
    startupLabel.ZIndex = 102
    ...
    spawn(function()
        ...
        TweenService:Create(startupBlur, TweenInfo.new(1.5), {ImageTransparency = 1}):Play()
        TweenService:Create(startupLabel, TweenInfo.new(1.5), {TextTransparency = 1}):Play()
        wait(1.5)
        startupFrame:Destroy()
        
        MainFrame.Visible = true
        MainFrame.Position = UDim2.new(1.5, -425, 0.5, -250)
        TweenService:Create(MainFrame, TweenInfo.new(0.8), {Position = UDim2.new(0.5, -425, 0.5, -250)}):Play()
