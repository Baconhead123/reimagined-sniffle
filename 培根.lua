local function loadScript()
    ...
    BackgroundCorner.CornerRadius = UDim.new(0, 11)
    ...
    TitleBarCorner.CornerRadius = UDim.new(0, 11)
    ...
    MinimizeCorner.CornerRadius = UDim.new(0, 5.3)
    ...
    CloseCorner.CornerRadius = UDim.new(0, 5.3)
    ...
    TabFrameCorner.CornerRadius = UDim.new(0, 11)
    ...
    for i, tabName in ipairs(Tabs) do
        ...
        TabButtonCorner.CornerRadius = UDim.new(0, 6.7)
    ...
    local function createButton(text, description)
        ...
        if description then
            button.MouseEnter:Connect(function()
                ...
                TooltipCorner.CornerRadius = UDim.new(0, 5.3)
    ...
    AnnouncementList.Parent = AnnouncementScrolling
    
    local AnnouncementPadding = Instance.new("UIPadding")
    ...
    AnnouncementPadding.Parent = AnnouncementScrolling
    ...
    local function loadSpeedLegend()
        playClickSound()
        loadstring(game:HttpGet("https://pastebin.com/raw/0A4J7V8M", true))()
...
print("安全版自然灾害免疫已激活")
    ...
    local function viewPlayerBackpack()
        ...
        BackpackStroke.Color = Color3.fromRGB(0, 150, 255)
        ...
        TitleBarCorner2.CornerRadius = UDim.new(0, 10)
        ...
        local CloseButtonCorner2 = Instance.new("UICorner")
        CloseButtonCorner2.CornerRadius = UDim.new(0, 5.3)
        CloseButtonCorner2.Parent = closeButton
        closeButton.Parent = titleBar
        ...
        local ContentPadding2 = Instance.new("UIPadding")
        ContentPadding2.PaddingTop = UDim.new(0, 3.3)
        ContentPadding2.Parent = contentFrame
        ...
        if #tools == 0 then
            ...
            for _, tool in ipairs(tools) do
                ...
                ItemFrameCorner.CornerRadius = UDim.new(0, 6.7)
                ItemFrameCorner.Parent = itemFrame
                local ItemFrameStroke = Instance.new("UIStroke")
                ItemFrameStroke.Color = Color3.fromRGB(100, 100, 200)
                ...
                StealButtonCorner.CornerRadius = UDim.new(0, 5.3)
