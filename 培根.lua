local function loadScript()
    ...
    local FunctionTabs = {
        ...
        ["FE功能"] = {
            ...
            {name = "FEFightingMovesButton", text = "FE格斗动作", desc = "加载FE格斗动作脚本"},
            ...
            {name = "FEAC6MusicVulnButton", text = "FE AC6漏洞放音乐", desc = "加载FE AC6漏洞放音乐脚本"}
        },
        ["黑洞功能"] = {
        ...
        ["其他脚本"] = {
            ...
            {name = "Ohio3Button", text = "俄亥俄州脚本3", desc = "加载俄亥俄州脚本3脚本"},
            {name = "Ohio4Button", text = "俄亥俄州脚本4", desc = "加载俄亥俄州脚本4脚本"},
            {name = "ServerForsakenButton", text = "在服务器玩被遗弃脚本", desc = "在服务器玩被遗弃脚本"}
        },
        ["doors"] = {
        ...
        ["其他脚本整合"] = {
            ...
            {name = "DrawMeScript1Button", text = "画我脚本1", desc = "加载画我脚本1脚本"},
            {name = "DrawMeScript2Button", text = "画我脚本2", desc = "加载画我脚本2脚本"},
...
print("安全版自然灾害免疫已激活")
    ...
    -- 在服务器玩被遗弃脚本
    local function loadServerForsaken()
        playClickSound()
    ...
    -- FE格斗动作
    local function loadFEFightingMoves()
        playClickSound()
    ...
    -- FE AC6漏洞放音乐
    local function loadFEAC6MusicVuln()
        playClickSound()
    ...
    local buttonActions = {
        ...
        FEFightingMovesButton = loadFEFightingMoves,
        ...
        FEAC6MusicVulnButton = loadFEAC6MusicVuln,
        ...
        ServerForsakenButton = loadServerForsaken,
