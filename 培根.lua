local function loadScript()
    ...
    local FunctionTabs = {
        ...
        ["FE功能"] = {
            ...
            {name = "FEFightingActionsButton", text = "FE格斗动作", desc = "加载FE格斗动作脚本"},
            ...
            {name = "FESnakeWithoutAccessoriesButton", text = "FE不要饰品的蛇", desc = "加载FE不要饰品的蛇脚本"},
            ...
            {name = "FEAntiKickButton", text = "FE防踢", desc = "加载FE防踢脚本"},
        ...
        ["其他脚本"] = {
            ...
            {name = "XAOhiostateButton", text = "xa俄亥俄州", desc = "加载xa俄亥俄州脚本"},
            {name = "DrawMeScript1Button", text = "画我脚本1", desc = "加载画我脚本1"},
            {name = "DrawMeScript2Button", text = "画我脚本2", desc = "加载画我脚本2"},
            {name = "PlayForsakenOnServerButton", text = "在服务器玩被遗弃脚本", desc = "加载在服务器玩被遗弃脚本"}
        },
        ["doors"] = {
...
print("安全版自然灾害免疫已激活")
    ...
    -- xa俄亥俄州
    local function loadXAOhiostate()
        playClickSound()
    ...
    -- FE格斗动作
    local function loadFEFightingActions()
        playClickSound()
    ...
    -- FE不要饰品的蛇
    local function loadFESnakeWithoutAccessories()
        playClickSound()
    ...
    local buttonActions = {
        ...
        FEFightingActionsButton = loadFEFightingActions,
        ...
        FESnakeWithoutAccessoriesButton = loadFESnakeWithoutAccessories,
        ...
        XAOhiostateButton = loadXAOhiostate,
