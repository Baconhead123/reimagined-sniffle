local function loadScript()
    ...
    local FunctionTabs = {
        ["基础功能"] = {
            ...
            {name = "DrainageCenterButton", text = "导管中心", desc = "加载导管中心脚本"}
        },
        ["移动功能"] = {
        ...
        ["FE功能"] = {
            ...
            {name = "FEScriptV2Button", text = "FE脚本整合v2", desc = "加载FE脚本整合v2"},
            ...
            {name = "FENoliButton", text = "FE诺丽", desc = "加载FE诺丽脚本"},
            ...
            {name = "FEMrSleepyButton", text = "FE Mr.睡不醒", desc = "加载FE Mr.睡不醒脚本"},
            {name = "FELaserCannonButton", text = "FE激光炮", desc = "加载FE激光炮脚本"},
            ...
            {name = "FESnakeNoDecoButton", text = "FE不要饰品的蛇", desc = "加载FE不要饰品的蛇脚本"},
            {name = "FESupermanButton", text = "FE超人", desc = "加载FE超人脚本"},
            {name = "FERevengerButton", text = "FE复仇者", desc = "加载FE复仇者脚本"},
            ...
            {name = "FEN00kla5KButton", text = "FE N00kla5K菜单", desc = "加载FE N00kla5K菜单"},
            {name = "FEAC6MusicButton", text = "FE AC6漏洞放音乐", desc = "加载FE AC6漏洞放音乐脚本"}
        },
        ["黑洞功能"] = {
        ...
        ["其他脚本"] = {
            ...
            {name = "PlayForsakenButton", text = "在服务器玩被遗弃脚本", desc = "加载在服务器玩被遗弃脚本"}
        },
        ["doors"] = {
        ...
        ["俄亥俄州"] = {
            ...
            {name = "OhioMoneyPrinterButton", text = "俄亥俄州捡印钞机", desc = "加载俄亥俄州捡印钞机脚本"},
            {name = "Ohio4Button", text = "俄亥俄州脚本4", desc = "加载俄亥俄州脚本4"},
            {name = "XAOhioButton", text = "xa俄亥俄州", desc = "加载xa俄亥俄州脚本"}
        },
        ["画我"] = {
            {name = "DrawMe1Button", text = "画我脚本1", desc = "加载画我脚本1"},
            {name = "DrawMe2Button", text = "画我脚本2", desc = "加载画我脚本2"}
        }
    }
...
print("安全版自然灾害免疫已激活")
    ...
    -- 俄亥俄州捡印钞机
    local function loadOhioMoneyPrinter()
        playClickSound()
    ...
    -- 在服务器玩被遗弃脚本
    local function loadPlayForsaken()
        playClickSound()
    ...
    -- FE激光炮
    local function loadFELaserCannon()
        playClickSound()
    ...
    -- FE不要饰品的蛇
    local function loadFESnakeNoDeco()
        playClickSound()
    ...
    local function loadFEAntiKick()
        ...
        showNotification("FE 防踢已加载!", Color3.fromRGB(0, 200, 0))
    end
    ...
    -- 导管中心
    local function loadDrainageCenter()
        playClickSound()
    ...
    local buttonActions = {
        ...
        DrainageCenterButton = loadDrainageCenter,
        ...
        FEScriptV2Button = loadFEScriptV2,
        ...
        FENoliButton = loadFENoli,
        FEGuest666Button = loadFEGuest666,
        FEKeyboardButton = loadFEKeyboard,
        FEScriptV3Button = loadFEScriptV3,
        FEWallJumpButton = loadFEWallJump,
        FEFightAnimButton = loadFEFightAnim,
        FER6HeadlessButton = loadFER6Headless,
        FER15HeadlessButton = loadFER15Headless,
        FEMrSleepyButton = loadFEMrSleepy,
        FELaserCannonButton = loadFELaserCannon,
        FESpiderButton = loadFESpider,
        FER15GladiatorButton = loadFER15Gladiator,
        FEZombieButton = loadFEZombie,
        FELaserButton = loadFELaser,
        FEBaboonButton = loadFEBaboon,
        FECrewButton = loadFECrew,
        FECreeperButton = loadFECreeper,
        FESnakeNoDecoButton = loadFESnakeNoDeco,
        FESupermanButton = loadFESuperman,
        FERevengerButton = loadFERevenger,
        FEDarkCreatureButton = loadFEDarkCreature,
        FEOfficialHammerButton = loadFEOfficialHammer,
        FEAntiKickButton = loadFEAntiKick,
        FEN00kla5KButton = loadFEN00kla5K,
        FEAC6MusicButton = loadFEAC6Music,
        ...
        PlayForsakenButton = loadPlayForsaken,
        ...
        BlackWhiteScriptButton = loadBlackWhiteScript,
        ArcticScriptCenterButton = loadArcticScriptCenter,
        NanningCenterButton = loadNanningCenter,
        ...
        Ohio3Button = loadOhio3,
        OhioMoneyPrinterButton = loadOhioMoneyPrinter,
        Ohio4Button = loadOhio4,
        XAOhioButton = loadXAOhio,
        
        -- 画我
        DrawMe1Button = loadDrawMe1,
        DrawMe2Button = loadDrawMe2
    }
    ...
    spawn(function()
        ...
        showNotification("培根脚本 v6.5 已加载!", Color3.fromRGB(0, 200, 255))
